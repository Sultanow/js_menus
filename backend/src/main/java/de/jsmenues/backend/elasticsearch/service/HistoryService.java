...
public class HistoryService {
    ...
    public static String deleteHistoryRecordsBydate() throws IOException {
        ...
        List<Map<String, Object>> allHistoryRcords = HistoryService.getAllHistoryRcords();
        ...
        for (Map<String, Object> record : allHistoryRcords) {
            ...
            if (unixTime > (longClock + HistoryDao.OLD_OF_HISTORY_RECORDS)) {
                ...
                deleteResponse = ElasticsearchConnector.restHighLevelClient.delete(request, RequestOptions.DEFAULT);
            }
        }
