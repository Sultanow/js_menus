...
answer = zapi.do_request('template.create', params={
                         "host": "TestTemplate", "groups": {"groupid": groupid}})
templateid = answer['result']['templateids'][0]
print("TemplateID: ", templateid)

# Create Application
answer = zapi.do_request('application.create', params={
                         "name": "TestApplication", "hostid": templateid})
...
answer = zapi.do_request(CREATEITEM, params=generate_item_params(
    "Hilfsapplication-Version", "version.helperapplication", applicationid))
answer = zapi.do_request(CREATEITEM, params=generate_item_params(
    "Silbentrennung", "config.silbentrennung", applicationid))
answer = zapi.do_request(CREATEITEM, params=generate_item_params(
